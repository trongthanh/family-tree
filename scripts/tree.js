...
function drawTree(treeData) {
	...
	function pan(domNode, direction) {
		...
		if (panTimer) {
			...
			if (direction == 'left' || direction == 'right') {
				translateX =
					direction == 'left' ? translateCoords.translate[0] + speed : translateCoords.translate[0] - speed;
				translateY = translateCoords.translate[1];
			} else if (direction == 'up' || direction == 'down') {
				translateX = translateCoords.translate[0];
				translateY =
					direction == 'up' ? translateCoords.translate[1] + speed : translateCoords.translate[1] - speed;
			}
	...
	$('body').hoverIntent({
		over: function() {
			...
			$('#bio')
				.html("<img src='" + $(this).attr('href') + "'>" + bio)
				.addClass('has-image')
				.fadeIn('fast');
		},
		out: function() {
